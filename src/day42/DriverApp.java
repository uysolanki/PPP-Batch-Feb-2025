...
public class DriverApp {
	...
	public static void main(String[] args) {
		...
		Car car1=new Car("Innova","Toyota","White",200.0,tyre1, engine1);  //CDI
		...
		car4.setCarMfgName("Mahindra");
		car4.setCarModelName("Thar");
		car4.setCarPrice(400.0);
		car4.setE1(engine2);				//SDI
		car4.setT1(tyre2);
